...
class Eden_Twitter_Friends extends Eden_Twitter_Base {
	...
	public function getFriendLists($id = null) {
		...
		$this->_query['include_user_entities'] = false;
		
		return $this->_getResponse(self::URL_FRIEND_LISTS, $this->_query);
	}
	...
	public function getFollowerLists($id = null) {
		...
		return $this->_getResponse(self::URL_FOLLOWER_LISTS, $this->_query);
	}
